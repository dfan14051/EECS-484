...
clear all
Nneurons = 6; %CHOOSE THIS; N=4 for  single "interneuron" case
INIT_WEIGHT_MAG = 1.0; %scale synapse initializations to random number +/- in this range
ETA = 0.2; %learning factor--tune this
ETASIG=0.2; %learning weight for adjusting initial conditions of interneurons--tune this
...
%          end
 %or faster in a single operation:
    ...
    total_iters = total_iters + niters
